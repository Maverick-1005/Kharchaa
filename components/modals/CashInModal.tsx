...
export default function CashInModal({ open, onClose, onSubmit }: { open: boolean, onClose: () => void, onSubmit: (data: { amount: string, description: string, category: string }) => void }) {
      ...
      <DialogContent className="max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <DialogFooter className="flex justify-end gap-2 mt-4">
            ...
            <Button type="submit" className="bg-green-500 hover:bg-green-600">Add Income</Button>
          </DialogFooter>
        </form>
      </DialogContent>
    </Dialog>
